...
class TestAttendaceModelViewSet:
    base_url = "/api/v1/attendances"

    def test_list_api(self, api_client, admin_user_token, attendance_factory):
        attendance_factory.create_batch(13)
    ...
    def test_retrieve_api(self, api_client, admin_user_token, attendance_factory):
    ...
    def test_create_api(
        self, api_client, admin_user_token, institute_factory, klass_factory, student_factory, subject_factory
    ):
        json_data = {
    ...
    def test_patch_update_api(self, api_client, admin_user_token, attendance_factory):
        attendance = attendance_factory.create()
        json_data = {
            "status": 2,
        }
    ...
    def test_delete_api(self, api_client, admin_user_token, attendance_factory):
        attendance = attendance_factory.create()
        jwt_token = admin_user_token
        api_client.credentials(HTTP_AUTHORIZATION=f"Bearer {jwt_token['access_token']}")
